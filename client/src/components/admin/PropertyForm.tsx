...
const PropertyForm = ({ property, mode, onSuccess }: PropertyFormProps) => {
  ...
  const createPropertyMutation = useMutation({
    mutationFn: async (data: PropertyFormValues) => {
      ...
      return await apiRequest("POST", "/api/properties", propertyData, getAuthHeader());
    },
    onSuccess: () => {
      toast({
        title: "Success",
  ...
  const updatePropertyMutation = useMutation({
    mutationFn: async (data: PropertyFormValues) => {
      ...
      return await apiRequest("PUT", `/api/properties/${property.id}`, propertyData, getAuthHeader());
    },
    onSuccess: () => {
      toast({
        title: "Success",
